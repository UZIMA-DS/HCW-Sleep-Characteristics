...
where[ParticipantIdentifier]  in (select [ParticipantIdentifier]  from [dbo].[StudyParticipants]) AND [resultidentifier] IN('asleep0_3', 'concentr0_3', 'down0_3', 'interest0_3', 'tired0_3','appetite0_3', 'activity0_3', 'failure0_3', 'suic0_3')
